...
let reviews = [
    {user: 'Vincenzo', description: `Il più bel sito di annunci`, rank: 5},
    {user: 'Goku', description: `Veramente non mi fà niente`, rank: 1},
    {user: 'Vegeta', description: `Mi piace tranne per star trek `, rank: 3},
    {user: 'Beerus', description: `Star wars è meglio`, rank: 4},
]
